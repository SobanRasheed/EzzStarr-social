...
import StoryCard from "../components/reuseable comps/StoryCard";
...
export default function StoriesPage() {
  ...
  return (
    <div className="min-h-screen pt-20 bg-black text-white px-8 py-12" style={{ fontFamily: "'Georgia', serif" }}>
